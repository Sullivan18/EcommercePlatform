...
const ProductCard = ({ product }) => {
  ...
  // Verifica se o preço é um número e aplica toFixed para formatar corretamente
  const formattedPrice = !isNaN(product.price) ? parseFloat(product.price).toFixed(2) : '0.00';
